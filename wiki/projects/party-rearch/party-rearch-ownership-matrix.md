...
| **Widget / SDK / Chakra strategy** | [[graph-team]] ([[joe-worsfold]] + [[billy-calladine]]) | [[prebind-team]] (consumer) | **Resolved 2026-05-13** ([[inrisk-cuts-over-before-high-volume]]): two component libraries — Chakra-3 + design-system for PCT, design-system-agnostic for InRisk; HV API-only. Closes [[open-questions#OQ-005]]. **Refined 2026-05-19**: InRisk is primarily Tailwind not Chakra; InRisk widget = **raw React + close-to-raw CSS** (one component, three parameterised variants in a shell container — parties / brokers / other); **[[billy-calladine]] formalised as owner of the widget rebuild AND the InRisk-side dispatch-code change**. PCT keeps Chakra 3 + design system (standalone, no clashes) |
| **Proxy-event-with-InRisk-data design** | [[graph-team]] ([[joe-worsfold]]) — proposer | [[prebind-team]] ([[john-trahearn]] / [[kris-mokrzycki]]) for Option A; [[graph-team]] for Option B | New 2026-05-19. **Gates the proxy adapter.** Two options: (A) InRisk endpoint (Joe's preference); (B) pull from [[knowledge-graph]] (parked over consistency concerns). Decision pending sanctions session with [[simon-hulbert]]. [[open-questions#OQ-041]] |
| **MDM integration-env unblock** | [[graph-team]] ([[joe-worsfold]]) | platform / Cognito-owning team | New 2026-05-19. DynamoDB stood up but JumpCloud SAML Cognito access broken; blocks integration-env smoke testing + Artificial-side exercise. [[open-questions#OQ-042]] |
| **Dynamo migration tooling** | [[graph-team]] ([[joe-worsfold]]) | [[graph-team]] internal first; [[dataops-team]] eventually | New 2026-05-19. Phase-1-vs-fast-follow-vs-ad-hoc scope open. [[open-questions#OQ-043]] |
| **PCT new-UI dataops parity confirmation** | [[graph-team]] ([[alex-sillars]] · [[tomas-sivo]]) | [[dataops-team]] · [[hugh-lobban]] (sponsor) | New 2026-05-19. Revisions + filters + mark-for-review / approve / request-changes baked in; walkthrough/user-test needed before cutover. [[open-questions#OQ-044]] |
| **PCT curation gap-analysis ticket authoring** | [[tomas-sivo]] ([[graph-team]]) | [[graph-team]] squad picks tickets up in-sprint | Formalised 2026-05-19 (Joe/Rory in-call routing). Distinct from the broader PCT functional-requirements workstream above |
...
Total open: **43** (35 prior + 8 new from 2026-05-19 MDM Implementation Strategy ingest: #38–#45).
...
| 38 | Formalise [[billy-calladine]]'s ownership of the **widget rebuild** (raw React + close-to-raw CSS; one component with three parameterised variants — parties / brokers / other — in a shell container; reuse existing InRisk components where possible) AND the **InRisk-side dispatch-code change** (the existing "which widget to call" logic on the InRisk side) | [[alex-sillars]] (to communicate to Billy) · [[billy-calladine]] (execute) | [[party-application]] · [[inrisk]] | open — 2026-05-19; refines [[inrisk-cuts-over-before-high-volume]] Part B |
| 39 | Resolve the **proxy-event-with-InRisk-data design fork**: (A) call an InRisk endpoint `client_id → {submissions, requirements}` (Joe's preference) vs (B) pull from [[knowledge-graph]] (Joe + Alex parked over consistency concerns). **Gates the proxy adapter.** Decision pending sanctions session with [[simon-hulbert]] | [[joe-worsfold]] (proposer) · [[john-trahearn]] / [[kris-mokrzycki]] (Option-A endpoint side) | [[party-application]] · [[inrisk]] · [[knowledge-graph]] | open — 2026-05-19; [[open-questions#OQ-041]] |
| 40 | Unblock the integration env: fix JumpCloud SAML Cognito access on the integration-env DynamoDB so any consumer can actually exercise it | [[joe-worsfold]] (or platform / Cognito-owning team) | [[party-application]] | open — 2026-05-19; [[open-questions#OQ-042]] |
| 41 | Re-run backfill in dev (and integration once unblocked) to land **stable alpha** — hundreds–thousands of real dev rows. Target: end of week 2026-05-22. Subsequent changes from this point forward additive only | [[joe-worsfold]] · [[ben-joseph]] | [[party-application]] | open — 2026-05-19 |
| 42 | Decide Phase-1 scope for **Dynamo migration tooling**: ship self-service in Phase 1, build Graph-team-internal first + treat self-service as fast-follow, or accept the cost ad-hoc | [[joe-worsfold]] (proposer) · [[alex-sillars]] | [[party-application]] | open — 2026-05-19; [[open-questions#OQ-043]] |
| 43 | Confirm DataOps parity with the new PCT UI (revisions + filters; mark-for-review / approve / request-changes baked in) — can DataOps users do everything they need? | [[alex-sillars]] · [[tomas-sivo]] · [[hugh-lobban]] (sponsor) | [[party-curation-tool]] | open — 2026-05-19; [[open-questions#OQ-044]] |
| 44 | Hand the **PCT curation gap-analysis ticket authoring** to [[tomas-sivo]]; the [[graph-team]] squad picks up the resulting tickets in-sprint | [[alex-sillars]] (route the ask) · [[tomas-sivo]] (author) | [[party-curation-tool]] | open — 2026-05-19 |
| 45 | Schedule a follow-up call in the next couple of days to consolidate immediate focuses + next steps + distribute | [[rory-beattie]] | [[party-application]] · [[party-curation-tool]] · [[inrisk]] | open — 2026-05-19 |
...
- 2026-05-26 — [[sources/20260519-mdm-implementation-strategy]] — **Widget / SDK / Chakra workstream sharpened**: InRisk-side fork is raw React + close-to-raw CSS (Tailwind correction); widget is one component with three parameterised variants in a shell; **[[billy-calladine]] formalised as owner** of both the rebuild and the InRisk-side dispatch-code change. **Five new workstreams added**: proxy-event-with-InRisk-data design; MDM integration-env unblock; Dynamo migration tooling; PCT new-UI dataops parity confirmation; PCT curation gap-analysis ticket authoring ([[tomas-sivo]]). **Eight new actions** added (#38–#45): widget + dispatch formalisation; proxy-event design fork; integration-env unblock; backfill-to-stable-alpha; Dynamo migration tooling scope; DataOps parity confirmation; curation gap-analysis routing; Rory follow-up scheduling. Open-action count: 35 + 8 = **43**.

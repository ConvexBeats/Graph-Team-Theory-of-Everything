...
_Top-level synthesis. Updated on every ingest. This is the evolving thesis of the programme._
...
6. **End-state items stay on the roadmap, off the critical path** — they're tracked in [[dependency-map]]'s end-state section and are the subject of Phase 2+ ADRs ([[feature-tagging-moves-to-inrisk]]) and open questions, but they don't gate Phase 1.
...
## Related
- [[dependency-map]] · [[ownership-matrix]] · [[open-questions]]
